...
LED_DRIVER_LOCAL_OBJ := $(notdir $(STM32L1xx_STD_PERIPH_LOCAL_SRC:.c=.o))
...
$(PROJECT_LIB_DIR)/$(LED_DRIVER_LIB_NAME):
	...
	$(NOECHO) cd $(LED_DRIVER_BUILD_DIR) && \
	          ...
	          mv $(LED_DRIVER_LIB_NAME) $(PROJECT_DIRECTORY)/lib/$(PROJECT_NAME)
